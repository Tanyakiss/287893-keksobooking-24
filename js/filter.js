import {createMarker, markerGroup} from './map-render.js';
import {SIMILAR_ADS_COUNT, PARSE_POINT} from './data.js';
...
const getRoomsNumber = (item) => accommodationRoomsSelect.value === FILTER_TYPE_ANY ? true : parseInt(accommodationRoomsSelect.value, PARSE_POINT) === item.offer.rooms;

const getGuestsNumber = (item) => accommodationGuestsSelect.value === FILTER_TYPE_ANY ? true : parseInt(accommodationGuestsSelect.value, PARSE_POINT) === item.offer.guests;
